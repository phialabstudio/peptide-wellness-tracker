...
### 📊 Dashboard
- **Today's Quick Check-In** — last injection, next scheduled dose, latest weight, side effects today
- **Hydration** — standalone card showing today's intake vs. goal with a progress bar
