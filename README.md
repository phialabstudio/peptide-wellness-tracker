...
**Track your injection schedule, side effects, weight progress, and wellness notes in one calm place.**

A private, browser-based health tracker for people on GLP-1 medications or peptide protocols. No accounts. No cloud. No data sharing — everything stays on your device.
...
3. Start logging — your data saves automatically in your browser
...
| Tab | What it does |
|---|---|
| 📊 Dashboard | Today's check-in, key metrics, weight trend, recent injections |
| 💉 Injection Log | Log and filter every injection by medication or phase |
| ⚠️ Wellness | Side effects, mood, hydration, and exercise tracking |
...
| ⚙️ Settings | Units, medications, reminders, goals, data management |
...
### 📊 Dashboard
- **Today's Quick Check-In** — last injection, next scheduled dose, latest weight, today's side effects, hydration progress
- **Metrics** — days in phase, total injections, active days, weight lost
- **Weight Trend** — visual chart of your recent progress
- **Recent Injections** — last 5 entries at a glance
- **Doctor Summary button** — generate a printable report
...
**Exercise**
- Choose from: Walking, Strength Training, Pilates, Yoga, Zumba, Cycling, Swimming, Stretching, or Other
- Log duration (minutes) and intensity (Low / Moderate / High)
- Add optional notes
- Exercise history table

**Hydration**
- Quick-add buttons (amounts update based on your selected unit)
...
- Protein level picker: Low / Medium / High / Not sure
- Carb level picker: Low / Medium / High / Not sure
- Enter exact grams if you have them, or just leave fields blank
- Today's macro summary with progress bars and pie chart
- Meal history filtered by date
...
### Medication List
- Add medications and peptides you want to track
...
- Choose medication, time, and repeat schedule (daily, weekly, weekdays, etc.)
...
- Opens in a new tab — use your browser's **File → Print** to save as PDF

Available from the **Dashboard** and from **Settings → Reports**.
